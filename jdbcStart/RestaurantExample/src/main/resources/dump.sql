...
ALTER TABLE DISHES ADD CONSTRAINT CATEGORY_ID_FK
...
ALTER TABLE DISHES_INGREDIENT ADD CONSTRAINT DISHES_ID_FK
FOREIGN KEY (DISHES_ID) REFERENCES DISHES (ID);
ALTER TABLE DISHES_INGREDIENT ADD CONSTRAINT INGREDIENT_ID_FK
FOREIGN KEY (INGREDIENT_ID) REFERENCES INGREDIENT (ID);
commit;