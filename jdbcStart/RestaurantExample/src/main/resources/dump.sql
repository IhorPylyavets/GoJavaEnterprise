...
CREATE TABLE DESKS (
  ...
  STATUS_OF_DESK DESK_STATUS NOT NULL
);
...
ALTER TABLE DISHES_INGREDIENTS ADD CONSTRAINT DISHES_ID_FK
FOREIGN KEY (DISHES_ID) REFERENCES DISHES (ID);
ALTER TABLE DISHES_INGREDIENTS ADD CONSTRAINT INGREDIENTS_ID_FK
...
ALTER TABLE MENUS_DISHES ADD CONSTRAINT MENUS_DISHES_ID_FK
FOREIGN KEY (MENUS_ID) REFERENCES MENUS (ID);
ALTER TABLE MENUS_DISHES ADD CONSTRAINT DISHES_MENU_ID_FK
FOREIGN KEY (DISHES_ID) REFERENCES DISHES (ID);
...
ALTER TABLE DISHES_ORDERS ADD CONSTRAINT DISHES_ORDER_ID_FK
FOREIGN KEY (DISHES_ID) REFERENCES DISHES (ID);
ALTER TABLE DISHES_ORDERS ADD CONSTRAINT ORDER_DISHES_ID_FK
