...
import com.goit.restaurant.dao.jdbc.mappers.WarehouseMapper;
...
public class JdbcWarehouseDao implements WarehouseDao {
    ...
    public void createWarehouse(Warehouse warehouse) {
        ...
        jdbcTemplateObject.update(sql, warehouse.getIngredientId(), warehouse.getAmount());
        LOGGER.info(String.format("Warehouse with parameters {%d, %f} is creating in DB", warehouse.getIngredientId(), warehouse.getAmount()));
    }
