...
<div class="container">
    ...
    <h1>Create / Update Dish</h1>
    <br />

    <spring:url value="/dishes" var="dishActionUrl" />

    <form:form class="form-horizontal" method="post" modelAttribute="dish_form" action="${dishActionUrl}">
