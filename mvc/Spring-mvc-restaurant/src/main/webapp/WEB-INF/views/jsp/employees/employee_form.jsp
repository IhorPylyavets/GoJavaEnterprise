...
<div class="container">
    ...
    <form:form class="form-horizontal" method="post" modelAttribute="employee_form" action="${employeeActionUrl}">
        ...
        <spring:bind path="salary">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                ...
                <div class="col-sm-10">
                    <form:input path="salary" type="number" min="0" class="form-control " id="salary" placeholder="Salary" />
